  ...
  return (
    <div>
      <FormControl sx={{ m: 1, minWidth: 223 }}>
        ...
        <Select required={true} labelId="demo-simple-select-helper-label" id="demo-simple-select-helper" value={categorydata.big_category_name} onChange={(e) => handleBig_category(e)}>
      ...
      <FormControl sx={{ m: 1, minWidth: 223 }}>
        ...
        <Select required={true} labelId="demo-simple-select-helper-label" id="demo-simple-select-helper" value={categorydata.small_category_name} onChange={(e) => handleSmall_category(e)}>
